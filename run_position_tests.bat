...
if not exist "Scripts\AI\Tuning\PositionTests.gd" (
    echo [ERROR] Scripts\AI\Tuning\PositionTests.gd is missing in THIS folder.
...
type tests_log.txt
echo ----------------------------------------------
echo (The same output was saved to tests_log.txt in this folder.)
pause
