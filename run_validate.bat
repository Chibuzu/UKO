...
if not exist "Scripts\AI\Tuning\ValidateChampion.gd" (
    echo [ERROR] Scripts\AI\Tuning\ValidateChampion.gd is missing in THIS folder.
...
echo.
"%GODOT%" --headless --path . --script "res://Scripts/AI/Tuning/ValidateChampion.gd" > validate_log.txt 2>&1
echo ---------------- test output ----------------
type validate_log.txt
echo ----------------------------------------------
echo (The same output was saved to validate_log.txt in this folder.)
pause
